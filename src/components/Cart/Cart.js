...
const Cart = (props) => {
  ...
  const submitOrderHandler = async (userData) => {
    ...
    await fetch(
      'https://food-order-a2aa1-default-rtdb.firebaseio.com/orders.json',
      {
        method: 'POST',
        body: JSON.stringify({
          user: userData,
  ...
  // this is wrapped in a React.Fragement because JSX code needs to be under one top tier element
